...
exports.run = async(client, message, args) => {
  ...
  var img2 = await jimp.read('sexo.png')
  jimp.read(img).then(avatar => {
    avatar.resize(250, 370)
    img2.composite(avatar, 17, 20).write('sexo_montagem.png')
    message.channel.send({
      files: [
        {
          attachment: 'sexo_montagem.png',
          file: 'sexo_montagem.png'
        }
      ]
    })
  }).catch(err => {
